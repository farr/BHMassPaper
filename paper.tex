...
\begin{figure}
  ...
  \caption{\label{fig:dists} The median (solid line), 10\% (lower
    ...
    \ref{sec:higher-mass}).  Error bars span the 10\% to 90\% range.
    Note that these ``distributions of distributions'' are not
    necessarily normalized, and need not be shaped like the underlying
    model distributions.}
\end{figure}
